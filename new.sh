...
sleep 20
if [[ -n $WEBHOOKS ]]; then echo Включаю детектор пропозалов! && sleep 2; nohup curl -s https://raw.githubusercontent.com/DecloudNodesLab/CodeBase/main/scripts/prop_detect.sh | bash & ; fi
